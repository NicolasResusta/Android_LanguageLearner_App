package uk.ac.aber.dcs.cs31620.multilingualapp.ui.anagramGame
...
import uk.ac.aber.dcs.cs31620.multilingualapp.ui.components.ScaffoldAnagramGameScreen
...
/**
 * This function represents the screen used to carry out the anagram game based on the foreign words
 * found in the Word database.
 *
...
fun AnagramGameScreen(
    ...
    if (words.isNotEmpty()) {
        ...
        // start is used to describe the original state of the textField.
        val nativeWShuffled = words[wordPosition].nativeWord.toCharArray().toList().shuffled()
        val foreignWShuffled = words[wordPosition].foreignWord.toCharArray().toList().shuffled()
        val foreignW = words[wordPosition].foreignWord

        ScaffoldAnagramGameScreen(
            navController = navController,
            ...
            pageContent = { innerPadding ->
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(id = R.string.anagram_game_question),
                            modifier = Modifier,
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            value = foreignWShuffled.joinToString(""),
                            onValueChange = {},
                            modifier = Modifier,
                            readOnly = true,
                            maxLines = 1,
