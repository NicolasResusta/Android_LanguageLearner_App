...
/**
 * This function represents the scaffolding arrangement for the changing language screen.
 *
...
@Composable
fun ScaffoldLanguageChangeScreen(
    ...
    Scaffold(
        topBar = {
            SmallTopAppBar(
                title = {
                    Text(
                        text = stringResource(id = R.string.language_change_screen_title),
